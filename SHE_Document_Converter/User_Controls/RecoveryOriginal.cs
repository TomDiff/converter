...
{
    public partial class RecoveryOriginal : UserControl
    {
        ...
        public RecoveryOriginal(string sql)
        {
            InitializeComponent();
            tbSQL.Text = sql;
        }
        ...
        private void InitGrid(DataTable table)
        {
            ...
            {
                table.Columns.Add(new DataColumn("Original", typeof(bool)));
        ...
        private void DoRecovery()
        {
            ...
            foreach (DataGridViewRow row in dgw.Rows)
            {
                ...
                ERecoveryStatus status = SheRecovery.Instance.RecoveryOriginal((int) row.Cells["Beleg_ID"].Value,
