...
{
    public partial class CheckForOriginal : UserControl
    {
        ...
        public CheckForOriginal(string sql)
        {
            InitializeComponent();
            tbSQL.Text = sql;
        }
        ...
        private void CallChecking()
        {
            ...
            foreach (DataGridViewRow row in dgw.Rows)
            {
                ...
                ERecoveryStatus status = SheRecovery.Instance.CheckAblage((int)row.Cells["Beleg_ID"].Value,
